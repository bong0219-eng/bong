...
var OAI_REFRESH_VEIL_MS = 1600; // V3-12: refresh veil must remain visible for at least 1.6s
...
function oaiApplyPendingRefreshVeil(){
  try{
    ...
    if(until > now){
      ...
      // early script가 이미 보호막을 켰더라도 app.js가 실제로 붙은 뒤부터 최소 1.6초를 보장한다.
      // 그래야 긴 새로고침처럼 리소스 로딩이 느린 경우에도 보호창이 너무 짧게 느껴지지 않는다.
